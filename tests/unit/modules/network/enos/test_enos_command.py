...
from ansible_collections.ansible.enos.plugins.modules import enos_command
...
class TestEnosCommandModule(TestEnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.enos.plugins.modules.enos_command.run_commands')
