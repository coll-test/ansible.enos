...
from ansible_collections.ansible.enos.tests.unit.compat.mock import patch
from ansible_collections.ansible.enos.plugins.modules import enos_config
from ..enos_module import TestEnosModule, load_fixture

from ansible_collections.ansible.enos.tests.unit.modules.utils import set_module_args
...
class TestEnosConfigModule(TestEnosModule):
    ...
    def setUp(self):
        self.patcher_get_config = patch('ansible_collections.ansible.enos.plugins.modules.enos_config.get_config')
        self.mock_get_config = self.patcher_get_config.start()
        self.patcher_exec_command = patch('ansible_collections.ansible.enos.plugins.modules.enos_config.load_config')
